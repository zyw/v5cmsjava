...
<head>
    ...
    <title>用户登录</title>
    <link rel="stylesheet" href="${basePath}/resources/backstage/css/bootstrap.css">
    <link rel="stylesheet" href="${basePath}/resources/backstage/css/bootstrap-theme.css">
    <link rel="stylesheet" href="${basePath}/resources/backstage/css/main.css">

    <script src="${basePath}/resources/backstage/js/jquery-1.8.3.min.js" type="text/javascript"></script>
    <script src="${basePath}/resources/backstage/js/bootstrap.min.js" type="text/javascript"></script>
</head>
<body>
<div class="panel panel-primary login-panel">
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="${contextPath}/admin/manager/login" method="post" role="form">
            ...
            <img id="vcode_img" src="${contextPath}/admin/manager/captcha" title="点击更换验证码"
