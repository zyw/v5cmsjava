	                                	...
	                                	<ul class="column clearfix">
	                                    	<li class="col-4-1">
	                                        	...
	                                        	<div class="portfolio-item">
			                                        <div class="portfolio-thumb-img"><a href="showcase-detail.ftl"><img src="images/upload/product-01.jpg" alt="" ></a></div>
			                                        <div class="portfolio-info">
		                                            	<h4><a href="showcase-detail.ftl">案例展示 - landing page</a></h4>
		                                            </div>
	                                            </div>
	                                            <!-- E portfolio-item -->
	                                        </li>
                ...
                <div class="sidebar-menu">
                    <div class="sidebar-menu-inner">
                        ...
                        <div class="sidebar-menu-cont">
                            <ul>
                                <li class="current"><a href="products.ftl">企业网站</a></li>
                                <li class=""><a href="products-col2.ftl">landing page 单页面</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
