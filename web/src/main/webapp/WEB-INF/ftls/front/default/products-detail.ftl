	                        	...
	                        	<div class="product">
		                            ...
		                            <div class="product-detail">
	                                	<div class="product-img">
	                                    	<img src="images/upload/product-01.jpg" width="250" height="182" alt="" />                                        
	                                    </div>
	                                    <div class="product-info">
	                                    	<div class="product-name"><h1>小米手机 3</h1></div>
	                                        <div class="product-summary">
	                                        	<div class="qhd-content">                                            	
	                                                <p><strong>顶级双平台全球首发</strong></p>
	                                                <p>NVIDIA Tegra 4 四核 28纳米 1.8GHz 全A15架构（TD）</p>
	                                                <p>高通骁龙800最新版8974AB 四核 2.3GHz（WCDMA）</p>
	                                            </div>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="product-desc">
	                                    	<div class="product-desc-tit">
	                                        	<h3>详情描述</h3>
	                                        </div>
	                                        <!-- S product-desc-content -->
	                                        <div class="product-desc-content">             
										        <div class="qhd-content">
	                                            	<div class="typo">
	                                                	<a href="#"><img src="images/upload/products-d-01.jpg" alt="" class="typo_img imgtoright" /></a>
	                                                	<div class="typo_text">
	                                                    	<h3>
	                                                        	就是快！<br />
																NVIDIA Tegra 4<br />
	                                                        ...
	                                                        <p>采用最新全A15构架，搭载72颗 GeForce 图形处理核芯。结合"4+1"省电核芯，还有全球最快 2GB LPDDR3 内存，eMMC 4.5 高规格闪存。 </p>
	                                                    </div>
	                                                </div>
	                                                ...
	                                                <div class="typo">
	                                                	<a href="#"><img src="images/upload/products-d-02.jpg" alt="" class="typo_img" /></a>
	                                                	<div class="typo_text">
	                                                    	<h3>
	                                                        	夏普/LG 5吋超灵敏触控视网膜屏<br />
																标准 16:9 全高清分辨率
	                                                        </h3>
	                                                        <p>屏幕更大，却更加细腻！1920 x 1080 分辨率，显示精度高达441PPI，超灵敏触控屏带着手套也可以进行操作，单玻璃全贴合技术还能有效防止眩光。</p>
	                                                    </div>
	                                                </div>
	                                                ...
	                                                <div class="typo">
	                                                	<a href="#"><img src="images/upload/products-d-03.jpg" alt="" class="typo_img imgtoright" /></a>
	                                                	<div class="typo_text">
	                                                    	<h3>
	                                                        	在暗光拍出明亮的照片<br />
																索尼1300万像素相机，飞利浦双LED闪光灯
	                                                        </h3>
	                                                        <p>搭载索尼Exmor RS 28mm 广角、F2.2 大光圈相机 ，特有双闪光灯功能可以拍出更明亮的照片，还支持更多专业功能和玩法！</p>
	                                                    </div>
	                                                </div>
	                                                
	                                            </div>             
										    </div>
	                                        <!-- E product-desc-content -->
	                                    </div>
	                                </div>
		                            <!-- E product-detail-->
	                            </div>
                ...
                <div class="sidebar-menu">
                    <div class="sidebar-menu-inner">
                        ...
                        <div class="sidebar-menu-cont">
                            <ul>
                                <li class="current"><a href="products.ftl">产品分类1</a></li>
                                <li class=""><a href="products-col2.ftl">产品图库-两列</a></li>
                                <li class=""><a href="products-col3.ftl">产品图库-三列</a></li>
                                <li class=""><a href="products-col4.ftl">产品图库-四列</a></li>
                                <li class=""><a href="products-col5.ftl">产品图库-五列</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="module module-sidebar">
                    <div class="mod-inner">
                    	<div class="mod-tit clearfix">
                        	<div class="mod-tit-group"><h3>热门资讯</h3></div>
                        </div>
                        <div class="mod-content">
                            <ul class="article-list-row">
                            	<li><a href="news-detail.ftl">互联网的扁平化设计之争</a></li>
                                <li><a href="news-detail.ftl">你的眼睛喜欢看什么？ </a></li>
                                <li><a href="news-detail.ftl">是否应该将iOS7设计风格融入你的应用？ </a></li>
                                <li><a href="news-detail.ftl">互联网的扁平化设计之争</a></li>
                                <li><a href="news-detail.ftl">你的眼睛喜欢看什么？ </a></li>
                            </ul>
                        </div>
			                    	...
			                    	<div class="module">
			                        	<div class="mod-inner">
			                                ...
			                                <div class="mod-content">
			                                    ...
			                                    <div class="qhd-content">
			                                    	<p>
				                                    	<a href="#" target="_blank"><img src="images/upload/ico-sina.gif" alt="新浪微博" title="点击关注新浪微博" /></a>&nbsp;&nbsp;
				                                    	<a href="#" target="_blank"><img src="images/upload/ico-tx.gif" alt="腾讯微博" title="点击关注腾讯微博" /></a>&nbsp;&nbsp;
				                                        <a href="#" target="_blank"><img src="images/upload/ico-douban.gif" alt="豆瓣" title="点击关注豆瓣"  /></a>&nbsp;&nbsp;
				                                    </p>
			                                    </div>
			                                    <!-- E qhd-content-->               
			                                </div>
