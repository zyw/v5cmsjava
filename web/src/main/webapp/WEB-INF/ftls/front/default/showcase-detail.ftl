                        	...
                        	<div class="mod-content">                        	
								...
								<div class="article">
									<div class="article-detail">
										<div class="article-title"><h1>为国教子 以德育人——幼儿师资培训班</h1></div>
										<div class="article-info">
											<span>所属分类：<a href="#">公司新闻</a></span>
											<span>发布时间：<strong>2012-09-25</strong></span>
										</div>
										<div class="article-cont">
											<div class="qhd-content">
	                                        	<p style="text-align:center;"><img src="images/upload/article-detail-img.jpg" alt="" /></p>
                ...
                <div class="sidebar-menu">
                    <div class="sidebar-menu-inner">
                        ...
                        <div class="sidebar-menu-cont">
                            <ul>
                                <li class="current"><a href="showcase.ftl">企业网站</a></li>
                                <li class=""><a href="showcase.ftl">landing page 单页面</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
