                    ...
                    <div class="module-default">
                        <div class="mod-inner">
                        	<div class="mod-content">
	                        	<!-- S link-line -->
	                        	<ul class="link-line clearfix">
	                                <li><a target="_blank" href="#">广州企互动科技有限公司</a></li>
	                                <li><a target="_blank" href="#">企互动</a></li>
	                                <li><a target="_blank" href="#">企互动</a></li>
	                                <li><a target="_blank" href="#">广州企互动科技有限公司</a></li>
	                                <li><a target="_blank" href="#">企互动</a></li>
	                                <li><a target="_blank" href="#">广州企互动科技有限公司</a></li>
                ...
                <div class="sidebar-menu">
                    <div class="sidebar-menu-inner">
                        ...
                        <div class="sidebar-menu-cont">
                            <ul>
                                <li class=""><a href="video.ftl">视频中心</a></li>
                                <li class="current"><a href="friend-link.ftl">友情链接</a></li>
