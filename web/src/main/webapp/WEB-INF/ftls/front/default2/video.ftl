	                                	...
	                                	<ul class="column clearfix">
	                                    	<li class="col-4-1">
	                                        	...
	                                        	<div class="portfolio-item">
			                                        <div class="portfolio-thumb-img"><a href="http://player.youku.com/player.php/sid/XNjA1MzExMjE2/v.swf" class="player-fancybox">
	                                                	<img src="images/upload/product-01.jpg" alt="" ></a>
	                                                </div>
			                                        <div class="portfolio-info">
		                                            	<h4><a href="http://player.youku.com/player.php/sid/XNjA1MzExMjE2/v.swf">视频中心 - 小米手机3</a></h4>
		                                            </div>
	                                            </div>
	                                            <!-- E portfolio-item -->
	                                        </li>
                ...
                <div class="sidebar-menu">
                    <div class="sidebar-menu-inner">
                        ...
                        <div class="sidebar-menu-cont">
                            <ul>
                                <li class="current"><a href="video.ftl">视频中心</a></li>
                                <li class=""><a href="friend-link.ftl">友情链接</a></li>
                                <li class=""><a href="jobs.html">人才招聘</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
