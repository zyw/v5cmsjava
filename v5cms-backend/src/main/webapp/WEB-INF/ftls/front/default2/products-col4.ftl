	                                ...
	                                <ul class="column clearfix">
	                                    <li class="col-4-1">
                                        	...
                                        	<div class="portfolio-item">
		                                        <div class="portfolio-thumb-img"><a href="products-detail.ftl"><img src="images/upload/product-01.jpg" alt="" ></a></div>
		                                        <div class="portfolio-info">
	                                            	<h4><a href="products-detail.ftl">产品名称</a></h4>
	                                            </div>
                                            </div>
                                            <!-- E portfolio-item -->
	                                    </li>
	                                    <li class="col-4-1">
	                                        <!-- S portfolio-item -->
                                        	<div class="portfolio-item">
		                                        <div class="portfolio-thumb-img"><a href="products-detail.ftl"><img src="images/upload/product-02.jpg" alt="" ></a></div>
		                                        <div class="portfolio-info">
	                                            	<h4><a href="products-detail.ftl">产品名称</a></h4>
	                                            </div>
                                            </div>
	                                    ...
	                                    <li class="col-4-1">
	                                        <!-- S portfolio-item -->
                                        	<div class="portfolio-item">
		                                        <div class="portfolio-thumb-img"><a href="products-detail.ftl"><img src="images/upload/product-03.jpg" alt="" ></a></div>
		                                        <div class="portfolio-info">
	                                            	<h4><a href="products-detail.ftl">产品名称</a></h4>
	                                            </div>
                                            </div>
                                        ...
                                        <li class="col-4-1 last">
	                                        <!-- S portfolio-item -->
                                        	<div class="portfolio-item">
		                                        <div class="portfolio-thumb-img"><a href="products-detail.ftl"><img src="images/upload/product-04.jpg" alt="" ></a></div>
		                                        <div class="portfolio-info">
	                                            	<h4><a href="products-detail.ftl">产品名称</a></h4>
	                                            </div>
                                            </div>
                ...
                <div class="sidebar-menu">
                    <div class="sidebar-menu-inner">
                        ...
                        <div class="sidebar-menu-cont">
                            <ul>
                                <li class=""><a href="products.ftl">产品分类1</a></li>
                                <li class=""><a href="products-col2.ftl">产品图库-两列</a></li>
                                <li class=""><a href="products-col3.ftl">产品图库-三列</a></li>
                                <li class="current"><a href="products-col4.ftl">产品图库-四列</a></li>
