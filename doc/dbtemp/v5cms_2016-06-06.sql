...
# Database: v5cms
# Generation Time: 2016-06-06 13:30:44 +0000
# ************************************************************
...
VALUES
	(10000,'例子Banner3','/res/uploads/10005/bannerfiles/1439130109484.jpg','',1,3,'<h1>banner演示</h1>\r\n                    <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>\r\n                    <p><a class=\"btn btn-large btn-primary\" href=\"#\">今天登录</a></p>'),
	(10003,'例子banner2','/res/uploads/10005/bannerfiles/1439130018597.jpg','',0,1,'<h1>banner演示</h1>\r\n                    <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>\r\n                    <p><a class=\"btn btn-large btn-primary\" href=\"#\">今天登录</a></p>'),
	(10008,'例子banner1','/res/uploads/10005/bannerfiles/1439129972510.jpg','',1,4,'sdfsdfsdfsdf'),
	(10009,'例子Banner4','/res/uploads/10005/bannerfiles/1439130178556.jpg','',1,5,'例子Banner4例子Banner4例子Banner4'),
	(10010,'例子Banner5','/res/uploads/10005/bannerfiles/1439130224375.jpg','',1,2,'例子Banner5例子Banner5例子Banner5例子Banner5');
...
INSERT INTO `system_res` (`id`, `pid`, `name`, `permission`, `url`, `sortNum`, `icon`, `pids`, `type`, `available`, `des`, `isParent`, `createAt`)
VALUES
	(3,0,'仪表盘','index:view','/index',0,'fa-dashboard','0/',1,1,'仪表盘',b'0','2016-06-06 21:27:30'),
	(4,0,'系统管理','system:*','',2,NULL,'0/',1,1,'系统管理一级菜单',b'0','2016-06-06 21:27:30'),
	(5,4,'资源管理','res:view','/res/list',0,NULL,'0/4/',1,1,'资源管理',b'0','2016-06-06 21:27:30'),
	(6,4,'角色管理','role:view','/role/list/1',1,NULL,'0/4/',1,1,'角色管理',b'0','2016-06-06 21:27:30'),
	(7,4,'用户管理','user:view','/user/list/1',2,NULL,'0/4/',1,1,'用户管理',b'0','2016-06-06 21:27:30'),
	(8,5,'资源新增','res:create','',0,NULL,'0/4/5/',2,1,'资源新增',b'0','2016-06-06 21:27:30'),
	(9,5,'资源修改','res:update','',1,NULL,'0/4/5/',2,1,'资源修改',b'0','2016-06-06 21:27:30'),
	(10,5,'资源删除','res:delete','',2,NULL,'0/4/5/',2,1,'资源删除',b'0','2016-06-06 21:27:30'),
	(11,6,'角色新增','role:create','',0,'','0/4/6/',2,1,'角色新增',b'0','2016-06-06 21:27:30'),
	(12,6,'角色修改','role:update','',1,'','0/4/6/',2,1,'角色修改',b'0','2016-06-06 21:27:30'),
	(13,6,'角色删除','role:delete','',2,'','0/4/6/',2,1,'角色删除',b'0','2016-06-06 21:27:30'),
	(14,7,'用户新增','user:create','',0,'','0/4/7/',2,0,'用户新增',b'0','2016-06-06 21:27:30'),
	(15,7,'用户修改','user:update','',1,NULL,'0/4/7/',2,1,'用户修改',b'0','2016-06-06 21:27:30'),
	(16,7,'用户删除','user:delete','',2,NULL,'0/4/7/',2,1,'用户删除',b'0','2016-06-06 21:27:30'),
	(17,7,'用户密码修改','user:pwd:update','',3,NULL,'0/4/7/',2,1,'用户密码修改',b'0','2016-06-06 21:27:30');
...
INSERT INTO `system_role` (`id`, `name`, `sortNum`, `pid`, `des`, `available`, `createAt`)
VALUES
	(9,'admin',1,0,'超级管理员',1,'2016-06-06 21:26:42'),
	(10,'超级管理员',3,0,'超级管理员',1,'2016-06-06 21:26:42'),
	(15,'网站编辑',10,0,'网站编辑',1,'2016-06-06 21:26:42'),
	(16,'test1',20,0,'是的方式的',0,'2016-06-06 21:26:42'),
	(17,'主站管理员',1,NULL,'主站管理员',1,'2016-06-06 21:26:42'),
	(18,'站点编辑',2,NULL,'站点编辑',1,'2016-06-06 21:26:42'),
	(19,'a',NULL,NULL,'',1,'2016-06-06 21:26:42'),
	(20,'网站策划',5,NULL,'网站策划',1,'2016-06-06 21:26:42'),
	(21,'ab',0,NULL,'abdef',1,'2016-06-06 21:26:42');
...
INSERT INTO `system_user` (`id`, `loginname`, `password`, `salt`, `name`, `email`, `sex`, `mobilephone`, `loginCount`, `lastLoginTime`, `originalPic`, `available`, `createAt`)
VALUES
	(1000,'zhangsan','887152dfd71fb7bfbb95c4d5ddb8d711','51dc770e65e4e2c2d5a63ba81f4110fc','张三','zhangsan@163.com',1,'',46,'2014-10-30 14:57:49','avatar1.jpg',1,'2016-06-06 21:28:40'),
	(1002,'lisi','894431bb71c1776a70a98eacf7ef3257','2eaa12542970e016e9afbfb713258d37','李四','lisi@163.com',1,'12345678963',29,'2014-11-05 19:34:37','1414391284915.png',1,'2016-06-06 21:28:40'),
	(1006,'wangwu','c1373439cee253ce306bce3f0c06b587','b646727c2c3581e7f8ec82327868df7a','王五','wangwu@163.com',0,'12345678963',7,'2014-10-30 10:03:58','avatar0.jpg',1,'2016-06-06 21:28:40');
