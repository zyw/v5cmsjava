...
) ENGINE=MyISAM AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='广告表';
...
) ENGINE=MyISAM AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='广告版位';
...
) ENGINE=MyISAM AUTO_INCREMENT=10020 DEFAULT CHARSET=utf8 COMMENT='文章标签表';

/*Data for the table `cols` */

insert  into `cols`(`colsId`,`columnName`,`colTypeId`,`sortNum`,`columndisplay`,`openWay`,`columnOutside`,`columnpic`,`parentId`,`parentIds`,`siteId`) values (10002,'Lucene',1000,5,1,'_self','','',0,'0/',10005),(10003,'Java',1000,3,1,'_self','','',0,'0/',10005),(10004,'WorldWind',1000,2,1,'_self','','columnpic/1385431453.png',0,'0/',10005),(10005,'Solr',1000,0,1,'_self','','',10002,'0/10002/',10005),(10015,'Struts2',1000,0,1,'_self','','',10003,'0/10003/',10005),(10016,'Swing',1004,1,1,'_self','','',10003,'0/10003/',10005),(10008,'Web前端',1000,0,1,'_self','','',0,'0/',10005),(10009,'jQuery',1000,0,1,'_self','','',10008,'0/10008/',10005),(10010,'jQueryEasyUI',1000,1,1,'_self','','',10008,'0/10008/',10005),(10019,'新闻',1000,5,1,'_self','','',10008,'0/10008/',10005);
...
) ENGINE=MyISAM AUTO_INCREMENT=1013 DEFAULT CHARSET=utf8 COMMENT='栏目类型表';
...
CREATE TABLE `site` (
  ...
  PRIMARY KEY (`siteId`)
) ENGINE=MyISAM AUTO_INCREMENT=10011 DEFAULT CHARSET=utf8 COMMENT='网站信息表';
