...
MySQL - 5.5.5-10.0.10-MariaDB : Database - v5cms
*********************************************************************
*/
...
CREATE TABLE `advpos` (
  ...
  `advPosDes` varchar(255) DEFAULT NULL,
  `advPosName` varchar(255) NOT NULL,
  `advPosState` int(11) NOT NULL,
  PRIMARY KEY (`advPosId`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='广告版位';

/*Data for the table `advpos` */

insert  into `advpos`(`advPosId`,`advPosDes`,`advPosName`,`advPosState`) values (1,'页头banner','页头banner',1),(2,'通栏广告2','通栏广告',1);
...
CREATE TABLE `site` (
  ...
  PRIMARY KEY (`siteId`)
) ENGINE=MyISAM AUTO_INCREMENT=10010 DEFAULT CHARSET=utf8 COMMENT='网站信息表';

/*Data for the table `site` */

insert  into `site`(`siteId`,`siteName`,`siteDeputyTitle`,`siteKey`,`siteDescribed`,`createDate`,`siteicp`,`siteStatisticCode`,`siteFooterInfo`,`isclosesite`,`themeName`) values (10005,'V5CM','java,WorldWind,Lucene','java,WorldWind,Lucene,Spring,SpringMVC','讲述java,WorldWind,Lucene,Spring,SpringMVC的博客网站','2014-02-22 00:00:00','陕ICP','<script type=\"text/javascript\">\nvar _bdhmProtocol = ((\"https:\" == document.location.protocol) ? \" https://\" : \" http://\");\ndocument.write(unescape(\"%3Cscript src=\'\" + _bdhmProtocol + \"hm.baidu.com/h.js%3Fbff6c22bb9ae0fcbf0fc35e23b9b02e8\' type=\'text/javascript\'%3E%3C/script%3E\"));\n</script>','<h3>V5Blog 平常心博客</h3>',1,NULL);
